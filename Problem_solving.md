...
I set up the Azure Foundry using the GPT-40 mini model and the Azure Vision Service on the regular Azure cloud system. 
...
Anthropic just rolled out a new feature. It's experimental. However, I want to see how well it can do. The time is 2.54. I am going to ask oh gosh I don't know if I trust this right I'm gonna ask it to finish the rest of the project based on the PRD I'm going to have it create a team of agents each with their own specialty and division and testing. 
